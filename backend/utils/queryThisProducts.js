class queryThisProducts {
  ...
  //       const matchesState = p.location.state === this.query.state;
  //       const matchesLGA = this.query.LGA
  //         ? p.location.LGA === this.query.LGA
  //         : true;
...
module.exports = queryThisProducts;
